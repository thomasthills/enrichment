...
wordsInWorld=5000
Associates = 100000 # Edges in environment
...
#pdf(file="EntropySim50001000001000.pdf", width=9, height=6)
par(mfrow=c(1,2))
...
plot(1:4, Slist[[1]][1,], cex = 0, ylim =c(0, 140), xlab = "Epoch", ylab = "Similarity", cex.lab = 1.5, xaxt="n")
axis(1, at=1:4, labels=c("1","2","3","4") )
...
legend(2.8, 140, legend=c(TeX('0'),TeX('1')), title=TeX('a'),col = c("black", "red"), lty = 1, bty="n", lwd = 1.5 )
legend(2.8, 110, legend=c(TeX('.01'), TeX('.1')), title=TeX('\\beta'), lty = 1:5, bty="n", lwd=1.5)
#dev.off()
